...
ASR_LIBRARY = [
    ...
    {"name": "Qwen-ASR v3 0.6B", "whisper_repo": "Qwen3-ASR-0.6B", "whisper_model": "qwen3-asr-0.6b", "repo": "Qwen/Qwen3-ASR-0.6B", "description": "Ultra-fast Qwen v3 ASR."},
    {"name": "Qwen-ASR v3 1.7B", "whisper_repo": "Qwen3-ASR-1.7B", "whisper_model": "qwen3-asr-1.7b", "repo": "Qwen/Qwen3-ASR-1.7B", "description": "Powerful Qwen v3 ASR."},
