        ...
        try:
            ...
            def _safe_llama_init(m_path, n_gpu_layers):
                try:
                    ...
                    # Catch ValueError as well, as llama-cpp-python uses it for invalid model files
            ...
            # Instead of "all layers" (-1), use a conservative layer offload count.
            # This avoids hard crashes on mid-range GPUs while still giving good speedups.
            if is_gpu:
                # Heuristic: offload at most 40 layers which fits well on 12GB-class GPUs
                n_gpu_layers = 40
            else:
                n_gpu_layers = 0
